...
brier_plot_tid <- ggplot() +
  ...
  labs(title = "", x = "Time", y = "Brier Score", color = "Survival model",
       linetype = "Survival model") +
  theme_minimal(base_size = 16) +
  theme(legend.position = "bottom")
brier_plot_tid 

# Save plot
ggsave(fig("sim_tid_brier_plot.pdf"), plot = brier_plot_tid, width = 8, height = 8)
...
# Save plot
ggsave(fig("sim_tid_surv_plot.pdf"), plot = surv_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_grad_plot.pdf"), plot = grad_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_grad_plot_norm.pdf"), plot = grad_plot_norm, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_smoothgrad_plot.pdf"), plot = smoothgrad_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_smoothgrad_plot_norm.pdf"), plot = smoothgrad_plot_norm, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_gradin_plot.pdf"), plot = gradin_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_grad_gradin_plot.pdf"), plot = grad_gradin_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_gradin_plot_norm.pdf"), plot = gradin_plot_norm, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_smoothgradin_plot.pdf"), plot = smoothgradin_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_smoothgradin_plot_norm.pdf"), plot = smoothgradin_plot_norm, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgrad0_plot.pdf"), plot = intgrad0_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgrad0_plot_comp.pdf"), plot = intgrad0_plot_comp, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgrad0_plot_contr.pdf"), plot = intgrad0_plot_contr, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgrad0_plot_force.pdf"), plot = intgrad0_plot_force, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgradmean_plot.pdf"), plot = intgradmean_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgradmean_plot_comp.pdf"), plot = intgradmean_plot_comp, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgradm_plot_contr.pdf"), plot = intgradm_plot_contr, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_intgradm_plot_force.pdf"), plot = intgradm_plot_force, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_gshap_plot.pdf"), plot = gshap_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_gshap_plot_comp.pdf"), plot = gshap_plot_comp, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_gshap_plot_contr.pdf"), plot = gshap_plot_contr, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_tid_gshap_plot_force.pdf"), plot = gshap_plot_force, width = 10, height = 15)
```
...
```{r tid gradshap, fig.width=10, fig.height=15}
# Compute GradShap
gshap_cox <- surv_gradSHAP(exp_coxtime, instance = 1:100, n = 50, num_samples = 50, 
                           batch_size = 1e6)
gshap_deephit <- surv_gradSHAP(exp_deephit, instance = 1:100, n = 50, num_samples = 50, 
                           batch_size = 1e6)
gshap_deepsurv <- surv_gradSHAP(exp_deepsurv, instance = 1:100, n = 50, num_samples = 50, 
                           batch_size = 1e6)
...
# Save plot
ggsave(fig("sim_tid_gshap_plot_contr_global.pdf"), plot = global_gshap_plot_contr, width = 10, height = 15)
```