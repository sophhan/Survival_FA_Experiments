...
# Save plot
ggsave(fig("sim_td_brier_plot.pdf"), plot = brier_plot_td, width = 8, height = 8)
...
# Save plot
ggsave(fig("sim_td_km_plot.pdf"), plot = km_plot$plot, width = 8, height = 8)
```
...
# Save plot
ggsave(fig("sim_td_grad_plot.pdf"), plot = grad_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_grad_plot_norm.pdf"), plot = grad_plot_norm, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_smoothgrad_plot.pdf"), plot = smoothgrad_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_smoothgrad_plot_norm.pdf"), plot = smoothgrad_plot_comp, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_gradin_plot.pdf"), plot = gradin_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_gradin_plot_norm.pdf"), plot = gradin_plot_norm, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_smoothgradin_plot.pdf"), plot = smoothgradin_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_smoothgradin_plot_norm.pdf"), plot = smoothgradin_plot_norm, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgrad0_plot.pdf"), plot = intgrad0_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgrad0_plot_comp.pdf"), plot = intgrad0_plot_comp, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgrad0_plot_contr.pdf"), plot = intgrad0_plot_contr, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgrad0_plot_force.pdf"), plot = intgrad0_plot_force, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgradmean_plot.pdf"), plot = intgradmean_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgradmean_plot_comp.pdf"), plot = intgradmean_plot_comp, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgradmean_plot_contr.pdf"), plot = intgradmean_plot_contr, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_intgradmean_plot_force.pdf"), plot = intgradmean_plot_force, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_gshap_plot.pdf"), plot = gshap_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_gshap_plot_comp.pdf"), plot = gshap_plot_comp, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_gshap_plot_contr.pdf"), plot = gshap_plot_contr, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("sim_td_gshap_plot_force.pdf"), plot = gshap_plot_force, width = 10, height = 15)
```
...
```{r td gradshap, fig.width=10, fig.height=15}
# Compute GradShap
gshap_cox <- surv_gradSHAP(exp_coxtime, instance = 1:500, n = 50, num_samples = 100, 
                           batch_size = 1e6, replace = FALSE)
gshap_deephit <- surv_gradSHAP(exp_deephit, instance = 1:500, n = 50, num_samples = 100, 
                           batch_size = 1e6, replace = FALSE)
gshap_deepsurv <- surv_gradSHAP(exp_deepsurv, instance = 1:500, n = 50, num_samples = 100, 
                           batch_size = 1e6, replace = FALSE)

# Plot contributions %
global_gshap_plot_contr <- cowplot::plot_grid(
  plot_contribution(gshap_cox, aggregate = TRUE) +
    geom_rug(data = test, aes(x = time), sides = "bl", linewidth = 0.5, alpha = 0.5), 
  plot_contribution(gshap_deephit, aggregate = TRUE) +
    geom_rug(data = test, aes(x = time), sides = "bl", linewidth = 0.5, alpha = 0.5), 
  plot_contribution(gshap_deepsurv, aggregate = TRUE) +
    geom_rug(data = test, aes(x = time), sides = "bl", linewidth = 0.5, alpha = 0.5),
  nrow = 3, labels = c("CoxTime", "DeepHit", "DeepSurv"))
global_gshap_plot_contr 

# Save plot
ggsave(fig("sim_td_gshap_plot_contr_global.pdf"), plot = global_gshap_plot_contr, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("main_grad_deephit_td.pdf"), plot = grad_deephit_plot, width = 10, height = 15)
```
...
# Save plot
ggsave(fig("main_gshap_coxtime_td.pdf"), plot = gshap_coxtime_plot, width = 10, height = 15)
```